  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <departmentModal v-if="showModal" @close="showModal = false" :all-employee="allDepartments">
        </departmentModal>
        <!-- /.container-fluid -->
      </section>
    </div>
      ...
      computed:{
          filtersearch(){
              return this.employees.filter(e => {
                return e.dept.match(this.searchTerm)
              })
          },
      },
      mounted(){
        Echo.channel('deptChannel')
        .listen('DepartmentEvent', (e) => {
          this.allDepartments()
